...
Rental scams, unfair housing language, and misleading listing information can create serious problems for renters, especially students, newcomers, and lower-income households. This project explores how Transformer-based NLP can help detect these risks earlier.
...
- dataset files or documented dataset access instructions
...
- generative AI or agent-based housing support workflows
